...
#define LOG_FILENAME "episode.log"
#define CONTROL_INPUT_FILENAME "episode_control.data"
#define IMAGES_FILENAME "episode_images.data"
...
int main()
{
     ...
     */
    std::ofstream image_file(IMAGES_FILENAME, std::ios::binary);
    unsigned char image[Camera.getImageTypeSize(raspicam::RASPICAM_FORMAT_RGB)];

    std::ofstream output_file;
    output_file.open(CONTROL_INPUT_FILENAME);
